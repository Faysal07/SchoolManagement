...
"""
# Create OS for calling HTML Templete
import os
...
SECRET_KEY = 'django-insecure-^)pdf80@e@l)987&13o7pl^qv&p4f06)l^0a4umr)fz!dpsw*e'
...
# Static Images Store Link
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR/ 'static']

# Media Images Store Link
MEDIA_URL = '/media/'
